...
enum class State { VALID, MOVED_FROM };
...
// [TOFIX]!!!
export MaybeSomething create_something_by_copying(const std::string &s);

// A function that 'takes' std::string and create Something object
// [TOFIX]!!!
export MaybeSomething create_something_by_moving(std::string &&s);
